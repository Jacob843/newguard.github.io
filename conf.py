...
BLOG_AUTHOR = "the Newguard team"  # (translatable)
BLOG_TITLE = "Newguard"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://newguard.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "newguard@edunham.net"
BLOG_DESCRIPTION = "The Newguard infrastructure engineering mentorship program"  # (translatable)
...
COMPILERS = {
    "rest": ('.rst', '.txt'),
    "markdown": ('.mkd', '.md', '.mdown', '.markdown'),
    "textile": ('.textile',),
    "txt2tags": ('.t2t',),
    "bbcode": ('.bb',),
    "wiki": ('.wiki',),
